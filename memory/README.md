...
|---|---|---|
| 2026-07-25 23:58 | [**Kết quả SPIKE + Phiên bản đã kiểm chứng**](20260725_2358-ket-qua-spike-va-phien-ban-da-kiem-chung.md) | **MỚI NHẤT.** SPIKE ĐẠT: render 183 ms + phát nhạc OK. Ghim `OSMD 1.9.7` + `@isamu/osmd-audio-player 1.0.0` + `opencv<5`. Bài học: phải test bằng bundler, không dùng CDN. |
